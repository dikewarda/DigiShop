...
<div class="site-section">
    ...
    <div class="row">
        <div class="col-md-12">
        <h2 class="h3 mb-3 text-black">Kontak</h2>
        </div>
        <div class="col-md-7">
        ...
        <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase">Malang</span>
            <p class="mb-0">Jl. Soekarno Hatta No.9, Jatimulyo, Kec. Lowokwaru, Kota Malang, Jawa Timur</p>
        </div>
    </div>
    </div>
</div>
