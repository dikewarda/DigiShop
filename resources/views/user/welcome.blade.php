@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/white.png);" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
    <td><img src="adminassets\assets\images\icon.png" sizes="50%" ></td>
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Cari Kebutuhan Percetakanmu Disini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Perlengkapan percetakan dan reklame disini terjamin kualitasnya dan tentunya barangnya sesuai. </p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Kualitas barangnya terjamin karena semuanya disini dengan bahan terbaik.</p>
        </div>
        </div>
