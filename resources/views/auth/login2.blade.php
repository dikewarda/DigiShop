            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="../../assets/images/logofixx.png">
                </div>
                <h4>Log In</h4>
                <h6 class="font-weight-light">Selamat datang di DigiShop silakan lakukan Log In.</h6>
                ...
                @enderror
                  ...
                  <div class="text-center mt-4 font-weight-light"> Sudah punya akun? <a href="/login" class="text-primary">Log In</a>
                  </div>
                </form>
              </div>
            </div>
