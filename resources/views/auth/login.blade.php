            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="{{ asset('adminassets') }}/assets/images/logofixx.png">
                </div>
                <h4>Log In</h4>
                ...
                <form class="pt-3" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Belum punya akun? <a href="/register" class="text-primary">Register</a>
                  </div>
                </form>
              </div>
            </div>
